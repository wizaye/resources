...
- ER diagrams and UML from OOP directly feed into [Low-Level Design](/system-design/lld/)
- CAP theorem, replication, and partitioning directly feed into [High-Level Design](/system-design/hld/)
