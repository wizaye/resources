...
1. [Math & Number Theory](./basic-foundation/math.md)
2. [Arrays & Strings](./data-structures/arrays-and-strings.md), the base every other pattern sits on top of
3. [Hashing](./data-structures/hashing-and-hashmaps.md), turns O(n) lookups into O(1), shows up inside half the patterns below
4. [Two Pointers](./algorithms/two-pointers.md)
5. [Sliding Window](./algorithms/sliding-window.md)
6. [Stacks & Queues](./data-structures/stacks-and-queues.md)

### Core

1. [Recursion](./basic-foundation/recursion.md), stop here longer than feels necessary if it isn't clicking yet
2. [Linked List](./data-structures/linked-list.md)
3. [Trees](./data-structures/trees.md)
4. [Binary Search Trees](./data-structures/binary-search-trees.md)
5. [Heaps](./data-structures/heaps.md)
6. [Tries](./data-structures/tries.md)
7. [Backtracking](./algorithms/backtracking.md)
8. [Greedy](./algorithms/greedy.md)

### Advanced

 1. [Graphs](./algorithms/graph-algorithms.md), basic traversal (BFS/DFS) is approachable right after Recursion, but this file goes all the way to weighted and directed graphs, which lean on Greedy and DP
 2. [Dynamic Programming](./algorithms/dynamic-programming.md), the topic most people fear, and the one the prerequisite chain above sets you up best for
 3. [Advanced Topics](./algorithms/advanced.md), Union-Find, Segment Trees, Dijkstra, Bellman-Ford, Floyd-Warshall, MST, Topological Sort, Bitmask DP
...
Then start with [Math & Number Theory](./basic-foundation/math.md), or [Arrays & Strings](./data-structures/arrays-and-strings.md) if you'd rather pick that up along the way.
