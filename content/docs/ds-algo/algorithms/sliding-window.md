...
> [!TIP]
> Notice this uses a hashmap to track window state, that's [Hashing](../data-structures/hashing-and-hashmaps.md) and Sliding Window composing together, which is normal. Most real interview problems combine two or three patterns from this repo, not just one in isolation.
