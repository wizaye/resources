...
> [!IMPORTANT]
> Encapsulation, inheritance, polymorphism, SOLID, and design patterns don't belong here. Those live in [OOP](../core-cs/object-oriented-programming.md) and LLD, and they come later.
...
> [!WARNING]
> This is "how to call sort()," not "how sort() works internally." Algorithm internals belong in [DSA](../ds-algo/README.md).
...
- **Coding interviews:** [DSA](../ds-algo/README.md)
- **Core interview subjects:** [Core CS](../core-cs/README.md)
- **Development roles:** Development
- **OOP:** [OOP](../core-cs/object-oriented-programming.md)
- **LLD / HLD:** LLD · HLD
